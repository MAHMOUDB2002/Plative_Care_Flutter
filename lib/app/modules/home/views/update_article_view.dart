                ...
                children: [
                  Stack(
                    children: [
                     ...
                     controller.imageArticle!=null?Image.file(File(controller.imageArticle!.path)): Image(image:NetworkImage("${argument['image']}"),height: 400,width: double.infinity,fit: BoxFit.cover,),
                      Padding(
